                ...
                <div class="row">
                    <div class="col-md-8">
                        <div class="form-group">
                            ...
                            <input type="text" wire:model="name" id="name" value="{{$product->post_title}}" class="form-control @error('name') is-invalid @enderror" required>
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" step="0.01" wire:model="regularPrice" id="regularPrice" class="form-control @error('regularPrice') is-invalid @enderror" value="{{$product->_regular_price}}" required>
                            @error('regularPrice') <div class="invalid-feedback">{{ $message }}</div> @enderror
                        </div>

                        <div class="form-group">
                            <label for="salePrice">Sale Price ($)</label>
                            <input type="number" step="0.01" wire:model="salePrice" id="salePrice" class="form-control @error('salePrice') is-invalid @enderror" value="{{$product->_price}}" >
