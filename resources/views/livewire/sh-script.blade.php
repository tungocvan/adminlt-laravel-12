<div class="row">
    <div class="col-6">
        ...
        <div class="my-3">
            ...
            <select id="scriptSelect" wire:model.live="selectedScript" class="form-control" wire:change="selectScript($event.target.value)">
        ...
        @if($selectedScript)
            <div class="my-3">
                ...
                <textarea class="form-control" rows="10" wire:model.live="scriptContent"></textarea>
            </div>
        ...
        <div class="my-3">
            ...
            <input type="text" wire:model.live="newScriptName" placeholder="Tên file (bao gồm đuôi .sh)" class="form-control my-1" />
            <button wire:click="saveScript" class="btn btn-outline-primary">
                Tạo Script
            </button>
        </div>
