    ...
    <div class="card-body">
        <div class="row">
            ...
            <div class="form-group col-md-6">
                ...
                <input type="text" wire:model.defer="nha_phan_phoi" class="form-control" id="nha_phan_phoi" placeholder="Nhập tên nhà phân phối">
            ...
            <div class="form-group col-md-6">
                ...
                <input type="text" wire:model.defer="nhom_thuoc" class="form-control" id="nhom_thuoc" placeholder="Nhập nhóm thuốc">
            ...
            <div class="form-group col-md-6">
                ...
                <input type="text" wire:model.defer="co_so_san_xuat" id="co_so_san_xuat" class="form-control">
            </div>

            <div class="form-group col-md-6">
                <label for="nuoc_san_xuat">Nước sản xuất</label>
                <input type="text" wire:model.defer="nuoc_san_xuat" id="nuoc_san_xuat" class="form-control">
            </div>

            <div class="form-group col-md-6">
                <label for="giay_phep_luu_hanh">Giấy phép lưu hành</label>
                <input type="text" wire:model.defer="giay_phep_luu_hanh" id="giay_phep_luu_hanh" class="form-control">
            </div>

            <div class="form-group col-md-6">
                <label for="han_dung">Hạn dùng</label>
                <input type="text" wire:model.defer="han_dung" id="han_dung" class="form-control">
            </div>

            <div class="form-group col-md-6">
                <label for="gia_ke_khai">Giá kê khai</label>
                <input type="number" wire:model.defer="gia_ke_khai" id="gia_ke_khai" class="form-control">
            </div>

            <div class="form-group col-md-6">
                <label for="don_gia">Đơn giá</label>
                <input type="number" wire:model.defer="don_gia" id="don_gia" class="form-control">
            </div>

            <div class="form-group col-md-6">
                <label for="gia_von">Giá vốn</label>
                <input type="number" wire:model.defer="gia_von" id="gia_von" class="form-control">
            </div>

            <div class="form-group col-md-6">
                <label for="trang_thai_trung_thau">Trạng thái trúng thầu</label>
                <select wire:model.defer="trang_thai_trung_thau" id="trang_thai_trung_thau" class="form-control">
