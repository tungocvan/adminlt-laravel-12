...
<div wire:ignore.self class="modal fade" id="gmailModal" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-lg">
      <form wire:submit.prevent="updateGmailConfig" class="modal-content">
        ...
        <div class="modal-body">
          <div class="form-group">
            ...
            <input wire:model.defer="gmail.client_id" type="text" class="form-control" placeholder="Nhập Client ID">
          </div>
          <div class="form-group">
            <label>GOOGLE_CLIENT_SECRET</label>
            <input wire:model.defer="gmail.client_secret" type="text" class="form-control" placeholder="Nhập Client Secret">
          </div>
          <div class="form-group">
            <label>GOOGLE_REDIRECT_URI</label>
            <input wire:model.defer="gmail.redirect" type="text" class="form-control" placeholder="https://your-domain.com/auth/google/callback">
          </div>
