...
<div wire:ignore.self class="modal fade" id="databaseModal" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-lg">
      <form wire:submit="updateDatabaseConfig" class="modal-content">
        ...
        <div class="modal-body">
          <div class="form-group">
            ...
            <input wire:model="database.connection" type="text" class="form-control">
          </div>
          <div class="form-group">
            <label>DB_HOST</label>
            <input wire:model="database.host" type="text" class="form-control">
          </div>
          <div class="form-group">
            <label>DB_PORT</label>
            <input wire:model="database.port" type="text" class="form-control">
          </div>
          <div class="form-group">
            <label>DB_DATABASE</label>
            <input wire:model="database.database" type="text" class="form-control">
          </div>
          <div class="form-group">
            <label>DB_USERNAME</label>
            <input wire:model="database.username" type="text" class="form-control">
          </div>
          <div class="form-group">
            <label>DB_PASSWORD</label>
            <input wire:model="database.password" type="password" class="form-control">
          </div>
