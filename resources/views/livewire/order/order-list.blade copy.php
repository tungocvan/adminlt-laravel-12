            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group mb-2">
                        <label>Email</label>
                        <input type="text" class="form-control" wire:model.defer="email" placeholder="Nhập email khách hàng">
                ...
                <div class="col-md-6">
                    <div class="form-group mb-2">
                        <input type="text" class="form-control" placeholder="Tìm kiếm thuốc..." wire:model.live.debounce.300ms="productSearch">
                    </div>
                    ...
                    <div class="table-responsive" style="max-height: 350px; overflow-y:auto;">
                        <table class="table table-bordered table-sm">
                            <thead class="thead-light sticky-top">
                                <tr>
                                    <th><input type="checkbox" wire:model="selectAllProducts"></th>
                                    <th>Tên thuốc</th>
                                    <th>Đơn vị</th>
                                    <th>Đơn giá</th>
                                    <th>Số lượng</th>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td><input type="checkbox" wire:click="toggleProduct({{ $product->id }})"
                                               @if(isset($selectedProducts[$product->id])) checked @endif></td>
                                    ...
                                    <td>
                                        ...
                                        <div class="input-group input-group-sm">
                                            ...
                                            <input type="text" class="form-control text-center"
                                                   wire:model.defer="selectedProducts.{{ $product->id }}.quantity" readonly>
                    ...
                    <tr>
                        ...
                        <td>
                            @if($order->link_download)
                                <a href="{{ $order->link_download }}" target="_blank">Tải xuống</a>
                            @else
                                -
                            @endif
                        </td>
                        <td>
                            ...
                            <button class="btn btn-sm btn-danger" wire:click="deleteOrder({{ $order->id }})"
                                onclick="return confirm('Bạn có chắc muốn xóa đơn #{{ $order->id }}?')">Xóa</button>
                        </td>
