<div class="container-fluid">
    <div class="form-row">
        <div class="form-group col-md-6">
            ...
            <input type="text" id="name" name="name" class="form-control" placeholder="Nhập tên" wire:model="user.name"
                required>
        </div>
        {{-- <div class="form-group col-md-6">
        ...
        <div class="form-group col-md-6">
            ...
            <input type="date" id="birthdate" class="form-control"
                wire:model.defer="user.birthdate">
        </div>
    </div>
    ...
    <div class="form-row">
        ...
        <div class="form-group col-md-6">
            ...
            <input type="password" id="password" name="password" class="form-control" 
                placeholder="{{ $isEdit ? 'Để trống nếu không đổi' : 'Nhập mật khẩu' }}" wire:model="user.password"
                {{ $isEdit ? '' : 'required' }}>
        </div>
    </div>
    ...
    <div class="form-row">
        <div class="form-group col-md-6">
            ...
            <input type="email" id="email" name="email" class="form-control" placeholder="Nhập email"
                wire:model="user.email" required>

        </div>

        <div class="form-group col-md-6">
            <label for="role">Role</label>
            <select id="role" name="role" class="form-control" wire:model="user.role">
        ...
        <div class="form-group col-md-6 d-flex align-items-center">
            <div class="form-group col-md-8">
                ...
                <input type="text" id="referral_code" name="referral_code" class="form-control"
                    placeholder="Mã giới thiệu" wire:model="user.referral_code">
            </div>
            <div class="custom-control custom-switch mt-4">
                <input type="checkbox" class="custom-control-input" id="is_admin" wire:model="user.is_admin">
